...
//
	@Test
		...
		driver.findElement(By.id("userEmail")).sendKeys("aiqueayesha6@gmail.com");
        ...
        String color = driver.findElement(By.xpath("//*[@id=\"lastName\"]")).getCssValue("border-color");
        ...
        String img = driver.findElement(By.id("lastName")).getCssValue("background-image");
